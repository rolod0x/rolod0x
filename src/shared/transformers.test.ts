...
describe('zeroPaddedAddress', () => {
  it('outputs an array of two zero-padded addresses', () => {
    expect(zeroPaddedAddress('0x6B175474E89094C44Da98b954EedeAC495271d0F', 'EVM')).toEqual([
  ...
  it('outputs an empty array for an invalid address', () => {
    expect(zeroPaddedAddress('DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK', 'Solana')).toEqual([]);
  });
});
